...
class CryptoPalsTestCase(unittest.TestCase):
    ...
    def test_likely_key_sizes(self):
        ...
        self.assertSequenceEqual(
            key_sizes,
            [
                (5, 1.2), (3, 2.0), (2, 2.5), (13, 2.5384615384615383),
                (11, 2.6363636363636362), (20, 2.7), (18, 2.7777777777777777),
                (38, 2.8684210526315788), (15, 2.933333333333333),
                (17, 2.9411764705882355), (7, 3.0), (8, 3.0), (16, 3.0),
                (21, 3.0476190476190474), (31, 3.096774193548387), (40, 3.1),
                (37, 3.108108108108108), (23, 3.1739130434782608),
                (29, 3.206896551724138), (14, 3.2142857142857144), (25, 3.24),
                (12, 3.25), (35, 3.257142857142857), (33, 3.272727272727273),
                (10, 3.3), (39, 3.3076923076923075), (19, 3.3157894736842106),
                (34, 3.323529411764706), (24, 3.375), (36, 3.4166666666666665),
                (30, 3.433333333333333), (32, 3.4375),
                (27, 3.4814814814814814), (4, 3.5), (26, 3.5),
                (28, 3.5357142857142856), (9, 3.5555555555555554),
                (22, 3.727272727272727), (6, 4.0)
            ]
        )
